...
namespace moment3.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(CollectionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artists != null ? 
                          ...
                          Problem("Entity set 'CollectionContext.Artists'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CollectionContext.Artists'  is null.");
            }
            var artist = await _context.Artists.FindAsync(id);
            if (artist != null)
            {
