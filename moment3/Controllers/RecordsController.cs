...
namespace moment3.Controllers
{
    public class RecordsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Year,ArtistId")] Record @record)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Year,ArtistId")] Record @record)
        {
            if (id != @record.Id)
            {
                return NotFound();
